...
def Add():
    ...
    mysqldb = mysql.connector.connect(host = "localhost",user = "root", password = "Ayush@123",database = "smschool")
...
def delete():
    ...
    try:
        ...
        mysqldb.commit()
        lastid = mycursor.lastrowid
        messagebox.showinfo("Information","Record Deleted Succesfully...")
